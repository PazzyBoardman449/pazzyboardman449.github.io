%% Solution to the Basic Morphogenisis equation with a single flux.
...
hold on
plot(t,p(:,30),'b','linewidth',3)
hold on
plot(t,p(:,160),'k','linewidth',3)
title('Plot of Morphogen Concentration Against Time','fontsize',16)
xlabel('Time t, s','fontsize',12)
ylabel('Concentration ρ(x,t), µm^-3','fontsize',12)
legend('x = 25µm','x = 75µm','x = 400µm','fontsize',12,'location','northwest')
%}
